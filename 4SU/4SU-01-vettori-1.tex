...
\item $43+74-29 =$
\item $\frac{11}{6} + \frac{7}{4} =$
\end{itemize}
\end{minipage}
\begin{minipage}[b]{.5\textwidth}
\begin{itemize}[leftmargin=*]
\item $2(x+3)+x =$
\item $\frac{x(2+y)-2x}{y} =$
\end{itemize}
\end{minipage}
...
\noindent
\begin{minipage}{.5\textwidth}
\subsection{Esercizio}\label{par695d1f91}
...
\begin{minipage}[c]{.5\textwidth}
\begin{center}
\includegraphics[width=.5\textwidth]{\pics/vettori-03}
\end{center}
\end{minipage}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\vspace{.5cm}
\subsection{Esercizio}\label{par695d1ef4}
Disegna due vettori e fanne la somma.
Disegna quattro vettori $\vec v_1$, $\vec v_2$, $\vec v_3$ e $\vec v_4$ e fai la somma $\vec v_1+\vec v_2+\vec v_3+\vec v_4$.


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\vspace{.5cm}
\subsection{Esercizio}\label{par695d1f0c}
Disegna tre vettori, scegli tre numeri, e fai almeno tre moltiplicazioni scalare per vettore.
Di due vettori $\vec v$ e $\vec w$, calcola graficamente $\vec v-\vec w$.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\vspace{.5cm}
%\subsection{Esercizio}\label{par695d1f14}
...
$\vec v=(1,1)$, $\vec w=(1,-2)$, $\vec z=(-2,0)$, $\vec k=(-1,-1)$.
Poi, disegna tu tre vettori e determinane le coordinate.
%Poi ancora, disegna i vettori $\vec v$, $\vec w$, $\vec u$ e $\vec k$ applicati al punto $P=(2,3)$.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\vspace{-.1cm}
\subsection{Esercizio}
Rifai gli Esercizi~\ref{par695d1f91}, \ref{par695d1ef4}, \ref{par695d1f0c}, in coordinate.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\subsection{Esercizio}
%Si prendano i vettori dall'Esercizio~\ref{par6957e1d8} e si facciano almeno tre somme.
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\subsection{Esercizio}
...
\begin{itemize}[leftmargin=*]
\item	$(a+b)(a-b) =$
\item	$\frac{32}{3^2 2^3} + \frac{27}{3^3 2} =$
\item	$2^a 4^b =$
\end{itemize}
\end{minipage}
