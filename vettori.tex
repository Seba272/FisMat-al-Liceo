...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Esercizio}
Disegna due vettori $\vec v$ e $\vec w$, e calcola graficamente $\vec v-\vec w$.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Versori}
Un \emph{versore} è un vettore di modulo 1.
I versori si indicano spesso con un cappuccio al posto della freccia: se un vettore $\vec v$ ha modulo 1, si può anche indicare come $\hat v$.

La caratteristica speciale dei versori è che,
se $\hat u$ è un versore e $t\in\R$, allora
\begin{equation}
	\norm{t\hat u} = \abs{t} .
\end{equation}
